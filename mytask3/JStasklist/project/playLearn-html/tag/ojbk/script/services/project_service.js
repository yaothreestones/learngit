angular.module("app")
    .factory('Course_service', function ($http, pathProject) {
        return {
            ...
            //同步预习接口
            //查看用户绑定教材详情
            get_BookLink: function (id) {
                return $http.get(pathProject.getBookLink_url(id))
            },
            //获取教材列表
            ...
            //微信预下单接口
            get_wx_prepay: function (data,params) {
                return $http.post(pathProject.getWXPrepay_url(), data,params)
            },
            //查询支付结果接口
            get_wx_pay_result:function (id) {
                return $http.get(pathProject.getWXPayResult_url(id))
            },
            //课程开始接口
