angular.module('app').config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$ocLazyLoadProvider',
    function ($stateProvider, $urlRouterProvider, $locationProvider, $ocLazyLoadProvider) {
        ...
        $stateProvider
            .state("app", {
                ...
                resolve: {
                    loadMyFile: _lazyLoad([
                        ...
                        "script/services/httpInterceptor.js"
                    ]),
                }
            })
            //前台开始页面
            ...
            //微信授权
            .state("app.wechat", {
                url: "/wechat?nickname&info&headimgurl",
                ...
                resolve: {
                    ...
                    configByRouter: function ($rootScope) {
                        ...
                        $rootScope.config.footNav.isShow = false;
                        $rootScope.config.headNav.page.isShow = true;
                    }
                }
            })
            //关联回家学习账号
            .state("app.binding", {
                ...
                resolve: {
                    loadMyFile: _lazyLoad([
                        "script/controllers/app/binding.js",
                    ]),
                    configByRouter: function ($rootScope) {
            ...
            .state("app.seekDetails", {
                ...
                controller:'seekDetailsCtrl as vm',
                resolve: {
                    loadMyFile: _lazyLoad([
                        "style/service/seek.css",
                        "script/controllers/service/seek/seekDetailsCtrl.js",
                        "script/controllers/app/app.js"
                    ]),
                    configByRouter: function ($rootScope) {
                        $rootScope.config.headNav.title = '资讯';
            ...
            //我的
            .state("app.mine", {
                url: "/mine?email&name&grade&profilePicture",
            ...
            //我的--修改个人资料页面
            .state("app.personal", {
                url: "/personal?name&grade&email&profilePicture",
            ...
            .state("app.ChangeMailbox", {
                url: "/ChangeMailbox?email&name&grade&profilePicture",
            ...
            //修改昵称
            .state("app.userData", {
                url: "/userData?email&name&grade&profilePicture",
                ...
                resolve: {
                    ...
                    configByRouter: function ($rootScope) {
                        $rootScope.config.headNav.title = '修改昵称';
                        $rootScope.config.headNav.isShow = true;
                        $rootScope.config.footNav.isShow = false;
                        $rootScope.config.headNav.backBtn.isShow = true;
                    }
            ...
            .state("app.record", {
                ...
                resolve: {
                    loadMyFile: _lazyLoad([
                        ...
                        "script/directives/seek/listen-done.js"
            ...
            .state("app.particulars", {
                url: "/particulars/{id}?title",
                templateUrl: 'view/service/mine/particulars.html',
                controller: 'particularsCtrl as vm',
                resolve: {
                    loadMyFile: _lazyLoad([
                        "style/service/seek.css",
                        "script/controllers/service/mine/particularsCtrl.js"
                    ]),
                    configByRouter: function ($rootScope) {
                        $rootScope.config.headNav.isShow = true;
                        $rootScope.config.footNav.isShow = false;
            ...
            .state("app.data", {
                url: "/data/data?there&choose&preview&dataFromCourse&dataFromPeriod&dataFromBook",
            ...
            .state("app.dataPay", {
                url: "/data/dataPay?periodOfCourse&periodOfBook&courseId&textbookId&periodId&dataFromCourse&dataFromPeriod&dataFromBook",
            ...
            .state("app.result", {
                url: "/course/data/payResult?result",
                ...
                resolve: {
                    ...
                    configByRouter: function ($rootScope) {
                        $rootScope.config.headNav.title = '支付结果';
                        $rootScope.config.headNav.backBtn.isShow = false;
                        $rootScope.config.footNav.isShow = false;
                    }
                }
