angular.module('app')
    .controller('missionCtrl',['$scope','$rootScope','$state','$stateParams','Course_service',
        function ($scope,$rootScope,$state,$stateParams,Course_service) {
            var vm = this;
            vm.tip = false;
            vm.video = false;
                    ...
                    Course_service.get_task_list(
                        ...
                        angular.forEach(vm.taskCount,function (data) {
                            if(data.id === parseInt($stateParams.taskId)){
                                ...
                                vm.select_studyStatus = data.studyStatus;
                            }
                        });
                        ...
                        vm.mission_select = function (x) {
                           console.log(x);
                               ...
                               vm.mission_isShow = false;
                               vm.select_studyStatus = x.studyStatus;
                        ...
                        vm.audioPlay.fill(1);
                        vm.videoPlay = new Array(vm.steps.length);
                        vm.videoPlay.fill(1);
                        ...
                        vm.playVideo = function (x) {
                            //这个和document.getElementById有什么区别？
                            vm.audio = angular.element('#video'+x)[0];
                            if(vm.audioPlay[x-1] === 1){
                                vm.audio.play();
                                vm.videoPlay[x-1] = 0;
                                console.log(vm.audioPlay)
