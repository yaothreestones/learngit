angular.module("app")
    .controller("mineCtrl", ["mineConstant", '$scope', '$state', '$rootScope', '$uibModal', 'Course_service',
        function (mineConstant, $scope, $state, $rootScope, $uibModal, Course_service) {
            ...
            vm.user = {
                profilePicture: vm.$stateParams.profilePicture,
                name: vm.$stateParams.name,
                grade:vm.$stateParams.grade,
                    ...
                    .then(function (res) {
                        ...
                        if (res.data.code == -3660) {
                            ...
                            var dialog = bootbox.dialog({
                                message: '<p class="text-center" style="margin: auto">该用户已签到</p>',
                                closeButton: false
                            });
                            setTimeout(function () {
                                dialog.modal('hide');
            ...
            vm.$signModal = {
                ...
                '<img src="image/mine/close.png"  style="width: 5vw;height: 5vw;position: absolute;top: 2vw!important;right: 2vw" ng-click="$close()">' +
