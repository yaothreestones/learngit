angular.module('app')
    .controller('courseDetailsCtrl',['$scope','$rootScope','$timeout','$state','$stateParams','Course_service',
                ...
                if(index === 0){
                    ...
                    if(vm.periodLists[index-1].studyStatus === 2){
                        ...
                        var dialog = bootbox.dialog({
                            message: '<p class="text-center" style="margin: auto">请先完成上一个课时</p>',
                            closeButton: false
                        });
                        setTimeout(function () {
                            dialog.modal('hide');
